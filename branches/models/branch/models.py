...
from .managers import BranchManager as manager
...
class Branch(models.Model):
    ...
    province = models.ForeignKey(
        ...
        db_index=False,
        on_delete=models.SET_NULL,
        related_name='branches_province'
    )
    ...
    created_by = models.ForeignKey(
        ...
        db_index=False,
        on_delete=models.SET_NULL,
        related_name='branches_created_by_user'
    )
    last_updated_by = models.ForeignKey(
        ...
        db_index=False,
        on_delete=models.SET_NULL,
        related_name='branches_updated_by_user'
    )
