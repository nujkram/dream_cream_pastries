...
from .managers import CakeCategoryManager as manager
...
class CakeCategory(models.Model):
    ...
    created_by = models.ForeignKey(
        ...
        related_name='cake_categories_created_by_user'
    )
    last_updated_by = models.ForeignKey(
        ...
        db_index=False,
        on_delete=models.SET_NULL,
        related_name='cake_categories_updated_by_user'
    )
...
# === Signals ===
################################################################################
@receiver(post_save, sender=CakeCategory)
def scaffold_post_save(sender, instance=None, created=False, **kwargs):
    pass


@receiver(pre_save, sender=CakeCategory)
