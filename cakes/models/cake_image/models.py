...
from .managers import CakeImageManager as manager
...
class CakeImage(models.Model):
    ...
    cake = models.ForeignKey(
        ...
        related_name='cake_images_created_by_user'
    )
    ...
    last_updated_by = models.ForeignKey(
        ...
        db_index=False,
        on_delete=models.SET_NULL,
        related_name='cake_images_updated_by_user'
    )
...
@receiver(pre_save, sender=CakeImage)
