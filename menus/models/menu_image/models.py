...
from .managers import MenuImageManager as manager
...
class MenuImage(models.Model):
    ...
    created_by = models.ForeignKey(
        ...
        db_index=False,
        on_delete=models.SET_NULL,
        related_name='menu_images_created_by_user'
    )
    last_updated_by = models.ForeignKey(
        ...
        db_index=False,
        on_delete=models.SET_NULL,
        related_name='menu_images_updated_by_user'
    )
