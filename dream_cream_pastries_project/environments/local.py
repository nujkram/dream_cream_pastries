"""
Django settings for Dream Cream Pastries Project project.
...
SITE_NAME = "Dream Cream Pastries Project"
SITE_ID = 1
SITE_URL = 'http://192.168.33.52'
ALLOWED_HOSTS = ['*', '9aed9873b040.ngrok.io']
...
try:
    with open(os.path.join(BASE_DIR, 'dream_cream_pastries_project/DEBUG')) as f:
        _debug = f.read().strip()
...
ROOT_URLCONF = 'dream_cream_pastries_project.urls'
...
WSGI_APPLICATION = 'dream_cream_pastries_project.wsgi.application'
...
# Channels
########################################################################################################################
ASGI_APPLICATION = "dream_cream_pastries_project.routing.application"
CHANNEL_LAYERS = {
    "default": {
